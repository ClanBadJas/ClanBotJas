...
DISCORD_VOICE_SCALER_ENABLE = os.getenv("VOICE_SCALER_ENABLE")
...
DISCORD_ROLEBOT_ENABLE = os.getenv("ROLEBOT_ENABLE")
DISCORD_ROLEBOT_SETTINGS_CHANNEL = _int(os.getenv('ROLEBOT_SETTINGS_CHANNEL'))

# Get Auto-Role settings
DISCORD_AUTO_ROLE_ENABLE = os.getenv("AUTO_ROLE_ENABLE")
DISCORD_AUTO_ROLES = os.getenv("AUTO_ROLES")

# Get Poll settings
DISCORD_POLL_ENABLE = os.getenv("POLL_ENABLE")
