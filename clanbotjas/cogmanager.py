...
class CogManager(commands.Cog):
    ...
    async def on_ready(self):
        await self.client.get_channel(settings.DISCORD_LOG_CHANNEL).send(":white_check_mark: Cog: \"cogmanager\" ready")
    ...
    async def unload(self, ctx: discord.ApplicationContext, cog: str):
        ...
        try:
            ...
            await self.client.get_channel(settings.DISCORD_LOG_CHANNEL).send(f":negative_squared_cross_mark: Cog: \"{cog}\" unloaded.")
